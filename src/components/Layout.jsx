...
import { LayoutDashboard, CheckSquare, Repeat2, BarChart3, Leaf, Menu, X, LogOut, AlertCircle } from 'lucide-react'
...
function LayoutContent({ children }) {
  ...
  return (
    <div className="min-h-screen bg-[#E0FFC2] flex">
      {/* Error Banner */}
      {error && (
        <div className="fixed top-4 left-1/2 -translate-x-1/2 z-50 animate-slide-up flex items-center gap-3 bg-red-100 border border-red-200 text-red-800 px-5 py-3 rounded-2xl shadow-xl">
